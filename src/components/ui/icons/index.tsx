...
const SearchIcon: React.FC<IconSvgProps> = ({size = 24, strokeWidth = 1.5, width, height, ...props}) => {
  return (
    <svg
      aria-hidden="true"
      fill="none"
...
export { BrandLogo, GoogleLogo, Spinner, MonoLock, PasswordVector, SearchIcon };
